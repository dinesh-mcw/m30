...
# num_frames = 1             #  This testbench is designed for single frame usage, M20_time_domain_boxcar_tb is an
                             #  example of a multi frames testbench
...
fov_num_to_use = 0
file_name_base = 'hdr_scene_thresh200_0_01_'
input_data_name, input_data_shape, perform_tap_add =\
    data_gen.load_sensor_data(path, file_name_base, 1, np.uint16, use_old_metadata_format, fov_num_to_use)
